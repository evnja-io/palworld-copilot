...
| `packages/game-data` | Generated JSON artifacts (pals, items, recipes, tech, buildings, maps, l10n) committed to the repo — the web app builds without running the pipeline. |
...
Palworld Companion is GPL-3.0 — you can run your own instance.
